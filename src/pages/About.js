    ...
    render() {
        return (
            <View style = { styles.info_container}>
                ...
                <Text style={styles.text}>      这一款app，旨在助力于课程信息流通，在打通闭塞的课程信息下，帮助同学们更好地选课。</Text>
                <Text style={styles.text}>      19年5月，初夏，我们拿到了动态主题课程项目。适逢暑期学期降至，脑海中逐渐泛起每次被交大选课系统支配的恐惧，回想起每次选课时左右为难的纠结。做个选课功能助手吧，也算为后来人谋点福利。</Text>
                ...
                <Text style={styles.right}>柳正威、煦扬、郭志、朱朝阳</Text>
            </View>
        );
    }
}
